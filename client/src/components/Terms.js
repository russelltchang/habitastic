    ...
    <>
      <div id="terms">
        ...
        <p>
          ...
          information for all purchases made on our website. You agree to
          promptly update your account and other information, including your
          email address, so that we can complete your transactions and contact
          you as needed.
        </p>

        <h3>SECTION 7 - USER GENERATED CONTENT</h3>
        <p>
        ...
        <p>
          ...
          relate to product descriptions, pricing, promotions, and offers. We
